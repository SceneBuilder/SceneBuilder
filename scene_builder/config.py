...
MSD_CSV_PATH = Path(__file__).parent / "msd_integration" / "data" / "mds_V2_5.372k.csv"  #importer folder moving.
# door zip adding.
DOOR_ADDON_ZIP_PATH = Path(__file__).parent / "msd_importer" / "data" / "addons_zip" / "Door It! Interior 4.0,4.1.zip" 
